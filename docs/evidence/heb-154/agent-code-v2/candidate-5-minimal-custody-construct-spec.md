# Candidate-5 minimal single-run custody
...
| Revision | 4 |
| Owner | Tad Haffey |
| Review trigger | separately authorized closure verification of SD-1 and SD-2, or change to any cited authority |
...
| Deliberation substrate | `DDR-HEB-154-001` revision 5, `C5-MIN-CUSTODY-1` revision 4, C5-R0/C5-R1/AC-1 through AC-4, RC-0 through RC-4 and SD-1/SD-2 |
| Supersedes | no mechanism; revision-5 construct is separately retired historical evidence |
...
- [`C5-MIN-CUSTODY-1`](candidate-5-minimal-custody-test-definition.md), SHA-256 `7f850b4c26e034a2472c19a9109e18df73b11398e09c99ec08d42fbcab266b02`, revision 4 preserves the same six-row review population and records that closure verification is not yet authorized.
...
Design-review artifacts remain repository-local under `reviews/candidate-5-minimal-custody-review-1/`, the targeted closure-review directory and the separately authorized supplemental direct-check directory. They bind exact design bytes but never enter a runtime image or become a launch precondition.

## Lifecycle gate

| Transition | Required evidence | Result |
|---|---|---|
| design acceptance | separately authorized closure verification of both supplemental findings plus explicit operator decision on exact revision-4 construct hash | pending |
